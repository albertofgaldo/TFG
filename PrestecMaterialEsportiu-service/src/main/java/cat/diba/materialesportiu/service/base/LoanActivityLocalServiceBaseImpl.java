...
import cat.diba.materialesportiu.service.LoanActivityLocalService;
...
/**
 * Provides the base implementation for the loan activity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cat.diba.materialesportiu.service.impl.LoanActivityLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class LoanActivityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LoanActivityLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cat.diba.materialesportiu.service.LoanActivityLocalServiceUtil} to access the loan activity local service.
	 */
	...
	public LoanActivity addLoanActivity(LoanActivity loanActivity)
		...
		return loanActivityPersistence.update(loanActivity);
	}
	...
	public LoanActivity createLoanActivity(long loanActivityId) {
		return loanActivityPersistence.create(loanActivityId);
	}
	...
	public LoanActivity deleteLoanActivity(long loanActivityId)
		...
		return loanActivityPersistence.remove(loanActivityId);
	}
	...
	public LoanActivity deleteLoanActivity(LoanActivity loanActivity) {
		return loanActivityPersistence.remove(loanActivity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LoanActivity.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return loanActivityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return loanActivityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public LoanActivity fetchLoanActivity(long loanActivityId) {
		return loanActivityPersistence.fetchByPrimaryKey(loanActivityId);
	}
	...
	public LoanActivity getLoanActivity(long loanActivityId)
		throws PortalException {
		return loanActivityPersistence.findByPrimaryKey(loanActivityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(loanActivityLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LoanActivity.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("loanActivityId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(loanActivityLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LoanActivity.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return loanActivityLocalService.deleteLoanActivity((LoanActivity)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return loanActivityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LoanActivity> getLoanActivities(int start, int end) {
		return loanActivityPersistence.findAll(start, end);
	}
	...
	public int getLoanActivitiesCount() {
		return loanActivityPersistence.countAll();
	}
	 ...
	 */
	public LoanActivityLocalService getLoanActivityLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("cat.diba.materialesportiu.model.LoanActivity",
			loanActivityLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"cat.diba.materialesportiu.model.LoanActivity");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LoanActivityLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = loanActivityPersistence.getDataSource();
	...
	@BeanReference(type = LoanActivityLocalService.class)
	protected LoanActivityLocalService loanActivityLocalService;
