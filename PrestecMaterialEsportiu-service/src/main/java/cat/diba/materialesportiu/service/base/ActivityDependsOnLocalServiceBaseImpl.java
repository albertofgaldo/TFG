...
import cat.diba.materialesportiu.service.ActivityDependsOnLocalService;
...
/**
 * Provides the base implementation for the activity depends on local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cat.diba.materialesportiu.service.impl.ActivityDependsOnLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ActivityDependsOnLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ActivityDependsOnLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cat.diba.materialesportiu.service.ActivityDependsOnLocalServiceUtil} to access the activity depends on local service.
	 */
	...
	public ActivityDependsOn addActivityDependsOn(
		...
		return activityDependsOnPersistence.update(activityDependsOn);
	}
	...
	public ActivityDependsOn createActivityDependsOn(long activityDependsOnId) {
		return activityDependsOnPersistence.create(activityDependsOnId);
	}
	...
	public ActivityDependsOn deleteActivityDependsOn(long activityDependsOnId)
		...
		return activityDependsOnPersistence.remove(activityDependsOnId);
	}
	...
	public ActivityDependsOn deleteActivityDependsOn(
		...
		return activityDependsOnPersistence.remove(activityDependsOn);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ActivityDependsOn.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return activityDependsOnPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return activityDependsOnPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ActivityDependsOn fetchActivityDependsOn(long activityDependsOnId) {
		return activityDependsOnPersistence.fetchByPrimaryKey(activityDependsOnId);
	}
	...
	public ActivityDependsOn getActivityDependsOn(long activityDependsOnId)
		throws PortalException {
		return activityDependsOnPersistence.findByPrimaryKey(activityDependsOnId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(activityDependsOnLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ActivityDependsOn.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("activityDependsOnId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(activityDependsOnLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ActivityDependsOn.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return activityDependsOnLocalService.deleteActivityDependsOn((ActivityDependsOn)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return activityDependsOnPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ActivityDependsOn> getActivityDependsOns(int start, int end) {
		return activityDependsOnPersistence.findAll(start, end);
	}
	...
	public int getActivityDependsOnsCount() {
		return activityDependsOnPersistence.countAll();
	}
	 ...
	 */
	public ActivityDependsOnLocalService getActivityDependsOnLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("cat.diba.materialesportiu.model.ActivityDependsOn",
			activityDependsOnLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"cat.diba.materialesportiu.model.ActivityDependsOn");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ActivityDependsOnLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = activityDependsOnPersistence.getDataSource();
	...
	@BeanReference(type = ActivityDependsOnLocalService.class)
	protected ActivityDependsOnLocalService activityDependsOnLocalService;
