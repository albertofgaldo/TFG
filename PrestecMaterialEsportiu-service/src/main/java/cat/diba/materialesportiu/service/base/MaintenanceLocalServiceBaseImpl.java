...
import cat.diba.materialesportiu.service.MaintenanceLocalService;
...
/**
 * Provides the base implementation for the maintenance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cat.diba.materialesportiu.service.impl.MaintenanceLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class MaintenanceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MaintenanceLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cat.diba.materialesportiu.service.MaintenanceLocalServiceUtil} to access the maintenance local service.
	 */
	...
	public Maintenance addMaintenance(Maintenance maintenance)
		...
		return maintenancePersistence.update(maintenance);
	}
	...
	public Maintenance createMaintenance(long maintenanceId) {
		return maintenancePersistence.create(maintenanceId);
	}
	...
	public Maintenance deleteMaintenance(long maintenanceId)
		...
		return maintenancePersistence.remove(maintenanceId);
	}
	...
	public Maintenance deleteMaintenance(Maintenance maintenance) {
		return maintenancePersistence.remove(maintenance);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Maintenance.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return maintenancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return maintenancePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return maintenancePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Maintenance fetchMaintenance(long maintenanceId) {
		return maintenancePersistence.fetchByPrimaryKey(maintenanceId);
	}
	...
	public Maintenance getMaintenance(long maintenanceId)
		throws PortalException {
		return maintenancePersistence.findByPrimaryKey(maintenanceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(maintenanceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Maintenance.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("maintenanceId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(maintenanceLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Maintenance.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return maintenanceLocalService.deleteMaintenance((Maintenance)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return maintenancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Maintenance> getMaintenances(int start, int end) {
		return maintenancePersistence.findAll(start, end);
	}
	...
	public int getMaintenancesCount() {
		return maintenancePersistence.countAll();
	}
	 ...
	 */
	public MaintenanceLocalService getMaintenanceLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("cat.diba.materialesportiu.model.Maintenance",
			maintenanceLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"cat.diba.materialesportiu.model.Maintenance");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MaintenanceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = maintenancePersistence.getDataSource();
	...
	@BeanReference(type = MaintenanceLocalService.class)
	protected MaintenanceLocalService maintenanceLocalService;
