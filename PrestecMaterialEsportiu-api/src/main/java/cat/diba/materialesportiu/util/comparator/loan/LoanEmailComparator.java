...
public class LoanEmailComparator extends OrderByComparator<Loan> {
	...
	public LoanEmailComparator(Locale locale) {
		this(false, locale);
	}
	
	public LoanEmailComparator(boolean ascending, Locale locale) {
	...
	public int compare(Loan loan1, Loan loan2) {
		...
		String email1 = StringUtil.toLowerCase(loan1.getEmail());
		String email2 = StringUtil.toLowerCase(loan2.getEmail());
