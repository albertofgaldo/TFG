...
public interface ActivityLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ActivityLocalServiceUtil} to access the activity local service. Add custom service methods to {@link cat.diba.materialesportiu.service.impl.ActivityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Activity> getActivitiesWithStockBetweenDates(Date startDate,
		Date endDate);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Activity> getActivityByCompanyGroup(long companyId, long groupId)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Activity> getActivityByCompanyGroup(long companyId,
		long groupId, int start, int end, OrderByComparator<Activity> obc)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Activity getActivityById(long activityId)
		throws SystemException, NoSuchActivityException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Activity> getAllActivities() throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Activity> getAvailableActivities(long activityId,
		long companyId, long groupId)
		throws SystemException, NoSuchActivityException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Activity> getAvailableStockActivity(long companyId, long groupId)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Activity> getChildActivityByActivityId(long activityId)
		throws SystemException, NoSuchActivityException;
