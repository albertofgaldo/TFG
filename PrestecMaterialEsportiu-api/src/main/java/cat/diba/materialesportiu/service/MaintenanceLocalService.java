...
/**
 * Provides the local service interface for Maintenance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MaintenanceLocalServiceUtil
...
public interface MaintenanceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MaintenanceLocalServiceUtil} to access the maintenance local service. Add custom service methods to {@link cat.diba.materialesportiu.service.impl.MaintenanceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Maintenance createMaintenance(long maintenanceId);
	...
	*/
	...
	public Maintenance deleteMaintenance(long maintenanceId)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Maintenance fetchMaintenance(long maintenanceId);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Maintenance> getMaintenanceByActivityId(long activityId,
		int start, int end) throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Maintenance getMaintenanceByActivityIdAndLabel(long activityId,
		String label) throws SystemException, NoSuchMaintenanceException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Maintenance> getMaintenanceByCompanyGroup(long companyId,
		long groupId, int start, int end, OrderByComparator<Maintenance> obc)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Maintenance> getMaintenanceByLoanIdIsDone(long loanId,
		boolean isDone);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Maintenance> getMaintenances(int start, int end);
