...
/**
 * Provides the local service interface for LoanActivity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LoanActivityLocalServiceUtil
...
public interface LoanActivityLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoanActivityLocalServiceUtil} to access the loan activity local service. Add custom service methods to {@link cat.diba.materialesportiu.service.impl.LoanActivityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public LoanActivity addLoanActivity(LoanActivity loanActivity)
		throws SystemException;
	...
	*/
	...
	public LoanActivity createLoanActivity(long loanActivityId);
	...
	*/
	...
	public LoanActivity deleteLoanActivity(LoanActivity loanActivity);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public LoanActivity deleteLoanActivity(long loanActivityId)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoanActivity fetchLoanActivity(long loanActivityId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LoanActivity> getActivityByLoanId(Long loanId)
		throws SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LoanActivity> getLoanActivities(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoanActivity getLoanActivity(long loanActivityId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoanActivity getLoanActivityByLoanIdActivityId(Long loanId,
		Long activityId) throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LoanActivity> getLoanByActivityId(Long activityId)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Material getMaterialByActivityId(long activityId)
		throws SystemException, PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public LoanActivity updateLoanActivity(LoanActivity loanActivity)
		throws SystemException;
}